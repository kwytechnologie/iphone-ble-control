# Documentação histórica do upstream — BleHid

Este arquivo foi preservado do projeto original. Menções a releases, medições e compatibilidade
se referem ao upstream. Para usar este fork, siga [README.md](README.md).
