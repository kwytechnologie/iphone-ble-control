...
public sealed class TrayIconService : IDisposable
{
    ...
    public TrayIconService(Action open, Action exit)
    {
        ...
        menu.Items.Add("Abrir iPhone BLE Control", null, (_, _) => open());
        menu.Items.Add(new Forms.ToolStripSeparator());
        menu.Items.Add("Sair", null, (_, _) => exit());

        _icon = new Forms.NotifyIcon
        {
            Text = "iPhone BLE Control",
    ...
    public void ShowMessage(string text) =>
        _icon.ShowBalloonTip(3000, "iPhone BLE Control", text, Forms.ToolTipIcon.Info);
    ...
    private void Redraw()
    {
        ...
        using var stream = Application.GetResourceStream(new Uri("pack://application:,,,/Assets/app-icon.ico")).Stream;
        using var source = new System.Drawing.Icon(stream, 32, 32);
        _current = (System.Drawing.Icon)source.Clone();
        _icon.Icon = _current;
        previous?.Dispose();
    }
